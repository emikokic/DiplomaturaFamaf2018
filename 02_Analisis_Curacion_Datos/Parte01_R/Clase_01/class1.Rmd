...
![Diplodatos @ FaMAF](./img/logos-diplomatura-3.png)
...
![Galileo observando con un telescopio](./img/13693233.jpg){
width=30% }

luego se desarrollaron modelos **teoricos** matematicos, generalizaciones

![Newton, Maxwell, Einstein, Dirac eqs](./img/maxwellseq.jpg){
width=30% }
...
![Simulacion cosmologica LCDM](./img/lcdm.jpeg){
width=40% 
}
...
![LSST telescopio y camara](./img/lsst.jpeg){
width=30% 
}
...
```{r}
#system.time(v1 + v2)  # ESO ESTA BIEN????
system.time(mydframe + 10*sin(0.75*pi))
```
